#!/usr/bin/env python3
"""
Geometric Multigrid (GMG) W-cycle solver using CSL with state machine
Runs complete W-cycle (γ=2) on device. Labels below that say "V-cycle" are from
the V-cycle parent; they refer to one outer multigrid iteration, which is now
a W-cycle traversal of the level hierarchy.
"""
