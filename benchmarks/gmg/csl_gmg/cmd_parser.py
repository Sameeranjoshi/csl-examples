...
def parse_args():
  ...
  parser.add_argument("--max-ite", default=20, type=int, help="maximum number of iterations of GMG")
  ...
  parser.add_argument('--bottom-iter', type=int, default=100, help='Number of bottom solver iterations (default: 100)')
