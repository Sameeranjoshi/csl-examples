...
echo "============================================"
echo "Compiling..."
cslc ./src/layout_gmg_vcycle.csl --arch wse3 --fabric-dims=26,20 --fabric-offsets=4,1 \
...
cs_python ./run_gmg_vcycle.py -m=16 -n=16 -k=16 --latestlink out_vcycle --channels=10 \
--width-west-buf=0 --width-east-buf=0 --zDim=16 --run-only --levels=4 --max-ite=1
