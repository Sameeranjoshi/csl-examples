...
cslc ./src/layout_gmg.csl --arch wse3 --fabric-dims=13,8 --fabric-offsets=4,1 \
--params=width:5,height:5,MAX_ZDIM:5 --params=BLOCK_SIZE:5 --params=C0_ID:0 \
...
cs_python ./run_gmg.py -m=5 -n=5 -k=5 --latestlink out --channels=1 \
