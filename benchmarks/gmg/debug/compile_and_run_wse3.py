...
def main():
    ...
    problems = [
        #  (4, 2, 1, 1e-5, 6, 6, 100),   # Tiny problem
        #  (8, 3, 1, 1e-5, 6, 6, 100),   # Tiny problem
         (16, 4, 1, 1e-5, 6, 6, 100),   # Small problem
        #  (32, 5, 1, 1e-5, 6, 6, 100),   # Small problem
        #  (64, 6, 1, 1e-5, 6, 6, 100),   # Medium problem
        #  (128, 7, 1, 1e-5, 6, 6, 100),   # Large problem
        #  (256, 8, 1, 1e-5, 6, 6, 100),   # Very large
        #  (512, 9, 1, 1e-5, 6, 6, 100),   # Very large
