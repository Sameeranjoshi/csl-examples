...
--params=width:4,height:4,MAX_ZDIM:2 --params=BLOCK_SIZE:2 --params=C0_ID:0 \
...
cs_python ./run.py -m=4 -n=4 -k=2 --latestlink out --channels=1 \
--width-west-buf=0 --width-east-buf=0 --zDim=2 --run-only
