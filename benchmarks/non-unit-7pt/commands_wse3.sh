...
echo "\n------------------------------------------------------------------------------------------------\n" >> results.txt.log
echo "OPTIMIZED(Level L fine grained level)" >> results.txt.log
echo "\n------------------------------------------------------------------------------------------------\n" >> results.txt.log
# Test cases for 8x8x8 with BLOCK_SIZE=2,4,8
# cslc ./src/layout.csl --arch wse3 --fabric-dims=15,14 --fabric-offsets=4,1 \
...
# tail -n 8 sim.log >> results.txt.log
...
# cslc ./src/layout.csl --arch wse3 --fabric-dims=11,10 --fabric-offsets=4,1 \
...
# cslc ./src/layout.csl --arch wse3 --fabric-dims=27,26 --fabric-offsets=4,1 \
